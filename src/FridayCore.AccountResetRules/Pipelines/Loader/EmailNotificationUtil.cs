...
{
    internal class EmailNotificationUtil : SendPasswordRecoveryMail
    {
        ...
        public MailMessage GenerateMailMessage(string username, string password)
        {
            using (new SecurityDisabler())
            {
                ...
                var recoveryEmailItem = Client.CoreDatabase.GetItem("{BBA733F7-6075-4D8C-944B-E254069DC93F}", Language.Parse(clientLanguage));
